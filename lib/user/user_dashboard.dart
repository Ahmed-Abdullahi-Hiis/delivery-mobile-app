...
//   // Firestore orders reference
//   final ordersRef = FirebaseFirestore.instance.collection('orders');

//   // Example: Replace auth.uid with actual user ID if using authentication
//   final String userId = "guest_or_user_id"; // <-- assign current user ID here
...
//             .where((o) => (o.data() as Map<String, dynamic>)['status'] == 'pending')
//             .length;
//         final delivered = orders
//             .where((o) => (o.data() as Map<String, dynamic>)['status'] == 'delivered')
//             .length;
